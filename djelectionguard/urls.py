...
urlpatterns = [
    ...
    InitiatorCreateView.as_url(),
    ContestInitiatorCreateView.as_url(),
    IssueTypeCreateView.as_url(),
    ContestIssueTypeCreateView.as_url(),
    ...
    ParentContestDeleteView.as_url(),
